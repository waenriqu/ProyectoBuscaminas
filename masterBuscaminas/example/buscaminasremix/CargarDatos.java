...
public class CargarDatos {
	int cont, revelados, vidas, combo, boards;
	double barrier;
	CharSequence time;
	Casilla [] board;
	Integer [] graphics;
	...
	public CargarDatos(int c, CharSequence r, Casilla [] t, Integer[] g, boolean perdiste, int revelados, int vidas, double barrier, int combo, int boards){
		this.cont=c;
		this.time=r;
		this.board=t;
		this.graphics=g;
