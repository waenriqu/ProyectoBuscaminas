...
public abstract class ModoPadre extends Activity{
	...
	public void resultScreen(int boards, int revelados){
			Intent intent = new Intent(this, ResultScreenSurvival.class);
			int score = boards*100 + revelados;
			intent.putExtra(TIEMPO_MESSAGE, "" + score);
			startActivity(intent);
		}
