...
Jugador_S jugadorS;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		jugadorS = new Jugador_S("NO ONE","INFINITY", this);
		updateRankingFacil();
		updateRankingNormal();
		updateRankingDificil();		
		updateRankingRemix();
		updateRankingSurvival();
	}
	...
	public void updateRankingSurvival(){
		int cont = 0;
		TextView nombresview5 = (TextView)findViewById(R.id.nombrelist5);
		TextView tiemposview5= (TextView)findViewById(R.id.tiempolist5);
		String nombres = "";
		String tiempos = "";
		ArrayList<Jugador> list = jugadorS.cargarPuntuacionSurvival();
		if(list!=null){
			for(Jugador j:list){
				if(cont<10){
					nombres = nombres + j.getNombre() + '\n';
			...
			nombresview5.setText((CharSequence)nombres);
			tiemposview5.setText((CharSequence)tiempos);
			nombresview5.invalidate();
			tiemposview5.invalidate();
		}
	}
}
