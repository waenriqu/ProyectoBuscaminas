...
/**
 * El Reloj controla los m騁odos que se deben de ejecutar periicamente
 * en el juego. La funci principal es contar el tiempo que transcurre en
 * la partida y mostr疵selo al jugador por pantalla, en el formato de un
 * reloj normal.
 * 
...
public class Reloj {
	 ...
	 * @param  activity el activity que usar�el reloj
	 * @return  Objeto reloj
	 */
	 ...
	 * @param  activity El activity que usar�el reloj
	 * @param  cont El valor que se le asignar�al contador de segundos 
	 * @return  Objeto reloj
	 */
	...
	/**
	 * Funci que el reloj ejecuta periodicamente. Incrementa el contador de
