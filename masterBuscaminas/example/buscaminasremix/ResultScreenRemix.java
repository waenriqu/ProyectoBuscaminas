 ...
 */
public class ResultScreenRemix extends ResultScreen {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		//setContentView(R.layout.activity_result_screen);
		diff = getResources().getString(R.string.button_remix);
	}

	@Override
	public boolean onCreateOptionsMenu(Menu menu) {
		// Inflate the menu; this adds items to the action bar if it is present.
		getMenuInflater().inflate(R.menu.result_screen_remix, menu);
		return true;
	}
	@Override
	public void addPuntuacion(View view){
		if(!finish){
			...
			setContentView(R.layout.activity_result_screen);
			jugador = new Jugador(myName, tiempo, ResultScreenRemix.this);
			jugador.guardarPuntuacionRemix();
			updateRanking();
			finish = true;
		}
	}
